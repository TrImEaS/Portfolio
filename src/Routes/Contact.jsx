...
export default function Contact() {
  ...
  return (
    <div name='contact' className='w-full h-screen dark:bg-slate-900
    flex justify-center items-center p-4'>
      ...
      <textarea className='dark:bg-[#ccd6f6] p-2' name="message" rows="10"></textarea>
      <button className='border-2 dark:hover:bg-cyan-500 dark:hover:border-cyan-500 hover:bg-[#378d86] hover:border-[#378d86] dark:border-white border-black px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
      </form>
    </div>
  )
}