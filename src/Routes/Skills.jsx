  ...
  return (
    ...
    <div name='skills' className='w-full h-screen dark:bg-slate-900 bg-slate-400 '>
      <section className='max-w-[840px] mx-auto p-4 flex flex-col justify-center w-full h-full px-6'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-10 gap-y-10 text-center py-8 text-gray-300'>
          ...
          <article className='flex flex-col gap-3 shadow-md shadow-[#040c166c] hover:scale-110 duration-500'>
          ...
          <article className='flex flex-col gap-3 shadow-md shadow-[#040c166c] hover:scale-110 duration-500 sm:col-span-2'>
            <img className='reactLogo w-20 mx-auto' src={ReactImg} alt="React icon" />
            <span>REACT</span>
          </article>
          <article className='group flex flex-col gap-3 shadow-md shadow-[#040c166c] hover:scale-110 duration-500 sm:col-span-2 group'>
      ...
      bg-slate-400 py-[200px]'>
          <article className='max-w-[840px] w-full h-full px-6'>
            <header>
              ...
              <p className='text-gray-300 py-10'>
              ...
              I began with tutorials on YouTube and websites like W3Schools and Stack Overflow, among others. Like everyone else at the beginning, <strong className='text-cyan-300'>
              ...
              <strong className='text-cyan-300'> I maintain a good pace, staying updated with the latest technologies and gaining experience in best practices</strong>.
              </p>
            </header>
          </article>
        </section>
